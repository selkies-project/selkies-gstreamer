...
**Encoders marked as "Recommended": Tested on Chromium where the encoder adds no perceptible delay from the host encoder even with a high (> 16 mbps) bitrate with an actively moving screen.**
